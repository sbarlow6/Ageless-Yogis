...
<div class="container graybg">
	<div class="navbar1 bordertest">  
            <ul class="navbarlist">
                <li class="navbaritem"><a href= "#" onclick="dropdown(0)" title= "Go to the about page">About <i class="fa fa-caret-down" aria-hidden="true"></i></a>
					<ul id="dropdown0" class="navbarsubitem backdropdown">
						<li class="navbarsubitem"><a href="..?action=about">About Us</a></li>
						<li class="navbarsubitem"><a href="..?action=friends">Our Friends</a></li>
					</ul>
                </li>
